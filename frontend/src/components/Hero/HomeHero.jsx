...
import BgImg from "../../assets/Images/blood donation.jpg";
      ...
      <div className="relative z-20 px-[4vw] py-16 md:py-24 lg:py-32">
        ...
        >
          ...
          <div className="text-white">
            ...
            >
              Get Your Hospital Supplies In One Place
            </motion.h1>
            ...
            >
              Blood, oxygen, and medical consumables and equipment delivered
              right to your doorstep. 24/7 safer and faster.
            </motion.p>
