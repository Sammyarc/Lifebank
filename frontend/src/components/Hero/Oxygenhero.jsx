...
import BgImg from "../../assets/Images/oxygen hero.jpg";
      ...
      <div className="relative z-20 px-[4vw] py-16 md:py-24 lg:py-32">
        ...
        >
          ...
          <div className="text-white">
            ...
            >
              Order high-purity (93%-95%) medical oxygen and have it delivered
              to your healthcare facility. Our oxygen is sourced from our plant
              and a network of oxygen plants we work closely with. All our
              partner plants follow international best practices, guaranteeing
