...
import BgImg from "../../assets/Images/blood donation 4.jpg";
      ...
      <div className="relative z-20 px-[4vw] py-16 md:py-24 lg:py-32">
        ...
        >
          ...
          <div className="text-white">
            ...
            >
              Order safe blood and blood products and have them delivered to
              your healthcare facility in 45 minutes or less. Blood and blood
              products are sourced from accredited blood banks and safely
              transported with WHO-recommended cold chain infrastructure.
            </motion.p>
