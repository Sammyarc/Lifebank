...
import skollLogo from "../../../assets/Images/skoll.png";
import Skoll from "../../../assets/Images/skollpartner-card.png";
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={Skoll}
          alt="Image of Skoll mobile app dashboard"
      ...
      >
        ...
        <div className="flex flex-row justify-center gap-2 lg:flex-col lg:justify-normal">
          ...
          >
            ...
            <p className="text-gray-700 font-bold">Skoll Foundation</p>
          </motion.div>
...
export default SkollPartnerCard;
