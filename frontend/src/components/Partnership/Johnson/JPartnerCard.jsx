...
import JLogo from "../../../assets/Images/johnson.png";
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={Son}
          alt="Image of SON worker with a carton of supplies"
      ...
      >
        ...
        <div className="flex flex-row justify-center gap-2 lg:flex-col lg:justify-normal">
          ...
          >
            ...
            <p className="text-gray-700 font-bold">Johnson & Johnson</p>
          </motion.div>
